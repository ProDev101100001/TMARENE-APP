  ...
  return (
    <div className="min-h-screen bg-background p-6 flex flex-col">
      <div className="mb-8">
        ...
        <p className="text-xs text-muted-foreground mt-2 text-center">الخطوة {step} من {totalSteps}</p>
      </div>
          ...
          <Card className="w-full max-w-md shadow-lg border-none">
            ...
            <CardContent className="space-y-6 text-right">
              <div className="space-y-3">
                ...
                >
                  <Label className="flex items-center justify-between p-3 border rounded-lg cursor-pointer hover:bg-primary/5 has-[:checked]:border-primary has-[:checked]:bg-primary/10">
        ...
        {step === 3 && (
          <Card className="w-full max-w-md shadow-lg border-none">
            <CardHeader className="text-right">
              ...
              <CardDescription>نقوم الآن بتحليل بياناتك وتجهيز خطة مخصصة لك</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6 text-right">
